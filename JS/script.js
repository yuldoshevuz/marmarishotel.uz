...
function caruselFunc(carousel, arrowIcons) {
    // const firstImg = selectAll(".corousel-img")[0].clientWidth +20
    ...
    arrowIcons.forEach(icon => {
        // let selectAll(".corousel-img")[0].clientWidth +20 = firstImg.clientWidth + 20;
    ...
    const autoSlide = () => {
        ...
        // let selectAll(".corousel-img")[0].clientWidth +20 = firstImg.clientWidth + 14;
